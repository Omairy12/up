	...
	tests := []struct {
		...
		},
		{
			...
			want: TestScreen{
				...
				Raw("«"), Raw("4567890x"), Raw("»"), Endline{0},
				Raw("«"), Wide2('茶'), Raw("67890x"), Raw("»"), Endline{0},
				Rows{W: 10, H: 5},
			},
		},
		{
...
睡觉`),
			want: TestScreen{
				Wide2('吃'), Wide2('饭'), Endline{6},
				Wide2('喝'), Wide2('茶'), Endline{6},
				Wide2('睡'), Wide2('觉'), Endline{6},
				Rows{W: 10, H: 7},
			},
		},
		{
			...
			want: TestScreen{
				...
				Raw("«"), Wide2('茶'), Raw("567890"), Raw("»"), Endline{0},
				Raw("««"), Raw("4567890"), Raw("»"), Endline{0},
				Raw("««"), Wide2('茶'), Raw("67890"), Raw("»"), Endline{0},
				Rows{W: 10, H: 6},
			},
		},
		{
			...
			want: TestScreen{
				...
				Raw("1234567"), Wide2('喝'), Raw("»"), Endline{0},
				Raw("123456"), Wide2('喝'), Raw("»»"), Endline{0},
				Raw("12345"), Wide2('喝'), Wide2('茶'), Raw("»"), Endline{0},
				Raw("1234"), Wide2('喝'), Wide2('茶'), Raw("9»"), Endline{0},
				Rows{W: 10, H: 3},
			},
		},
		{
